  ...
  return (
    <section className="relative overflow-hidden px-4 pt-20 pb-10 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="mt-6 mx-auto grid max-w-lg grid-cols-1 gap-4 text-center sm:grid-cols-3">
          <div>
            <div className="text-2xl font-semibold text-foreground sm:text-3xl">10k+</div>
            <div className="mt-1 text-sm text-muted-foreground">Active Jobs</div>
          </div>
          <div>
            <div className="text-2xl font-semibold text-foreground sm:text-3xl">5k+</div>
          ...
          <div>
            ...
            <div className="mt-1 text-sm text-muted-foreground">Match Rate</div>
          </div>
        </div>
      </div>
    </section>
