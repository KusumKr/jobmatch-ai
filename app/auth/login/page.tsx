...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        title: "Welcome back!",
        description: "Signing in... Redirecting to dashboard",
      })
      setTimeout(() => {
        window.location.href = role === "candidate" ? "/dashboard/candidate" : "/dashboard/recruiter"
      }, 1500)
    }, 1500)
  }
    ...
    <div className="w-full max-w-md">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          {role === "candidate"
            ? "Sign in to access your job matches and career insights"
            : "Sign in to manage your job postings and candidate matches"}
        </p>
      </div>
