...
import { Upload, BarChart3, CheckCircle2, AlertCircle } from "lucide-react"
    ...
    <div className="flex-1 bg-background">
      ...
      <div className="p-8 max-w-4xl mx-auto">
        <div className="rounded-xl border border-border bg-card/50 backdrop-blur-sm p-8">
          ...
          <div className="mb-8">
            <label className="block w-full rounded-xl border-2 border-dashed border-primary/30 bg-primary/5 p-12 text-center cursor-pointer hover:border-primary hover:bg-primary/10 transition">
